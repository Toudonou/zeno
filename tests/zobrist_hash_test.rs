...
mod zobrist_hash_test {
  ...
  fn test_zobrist_hash_normal_move_by_white() {
    let mut position = Position::from_fen("3b1rk1/1bq3pp/5pn1/1p2rN2/2p1p3/2P1B2Q/1PB2PPP/R2R2K1 w - - 0 1");
  ...
  fn test_zobrist_hash_short_castle_by_white() {
    let mut position = Position::from_fen("r1bqkb1r/pppp1ppp/2n2n2/1B2p3/4P3/5N2/PPPP1PPP/RNBQK2R w KQkq - 4 4");
    assert_eq!(position.get_side(), PieceColor::White);
  ...
  fn test_zobrist_hash_long_castle_by_white() {
    let mut position = Position::from_fen("rnb1kb1r/pp3ppp/4p3/q2p4/3QnB2/2N5/PPP1PPPP/R3KBNR w KQkq - 0 8");
    assert_eq!(position.get_side(), PieceColor::White);
  ...
  fn test_zobrist_hash_en_passant_move_by_white() {
    let mut position = Position::from_fen("r1bqkbnr/ppp3pp/2n5/4Pp2/2Bp4/5N2/PP3PPP/RNBQK2R w KQkq f6 0 7");
    assert_eq!(position.get_side(), PieceColor::White);
  ...
  fn test_zobrist_hash_promotion_move_by_white() {
    let mut position_for_knight_promotion = Position::from_fen("r1b1kbnr/ppp3Pp/3q4/4n3/2Bp4/5N2/PP3PPP/RNBQK2R w KQkq - 1 9");
    ...
    position_for_knight_promotion.make_move(mov);

    let mut position_for_bishop_promotion = Position::from_fen("r1b1kbnr/ppp3Pp/3q4/4n3/2Bp4/5N2/PP3PPP/RNBQK2R w KQkq - 1 9");
    ...
    position_for_bishop_promotion.make_move(mov);

    let mut position_for_rook_promotion = Position::from_fen("r3kbnr/1pP3pp/p7/3qn3/3pP1b1/5N2/P4PPP/RNBQ1RK1 w - - 1 12");
    ...
    position_for_rook_promotion.make_move(mov);

    let mut position_for_queen_promotion = Position::from_fen("r3kbnr/1pP3pp/p7/3qn3/3pP1b1/5N2/P4PPP/RNBQ1RK1 w - - 1 12");
    ...
    position_for_queen_promotion.make_move(mov);

    let expected_position_for_knight_promotion = Position::from_fen("r1b1kbnN/ppp4p/3q4/4n3/2Bp4/5N2/PP3PPP/RNBQK2R b KQq - 0 9");
    let expected_position_for_bishop_promotion = Position::from_fen("r1b1kBnr/ppp4p/3q4/4n3/2Bp4/5N2/PP3PPP/RNBQK2R b KQkq - 0 9");
    let expected_position_for_rook_promotion = Position::from_fen("r1R1kbnr/1p4pp/p7/3qn3/3pP1b1/5N2/P4PPP/RNBQ1RK1 b - - 0 12");
  ...
  fn test_zobrist_hash_normal_move_by_black() {
    let mut position = Position::from_fen("r3r1k1/p1p2ppp/Q7/1p6/1P3p1b/5q1N/P4N1P/3R1K1R b - - 1 26");
    assert_eq!(position.get_side(), PieceColor::Black);
  ...
  fn test_zobrist_hash_short_castle_by_black() {
    let mut position = Position::from_fen("rn2k2r/ppp1bppp/8/5q2/2NP1p2/2P2P1N/PP3K1P/R2Q1B1R b kq - 0 15");
    assert_eq!(position.get_side(), PieceColor::Black);
  ...
  fn test_zobrist_hash_long_castle_by_black() {
    let mut position = Position::from_fen("r3k2r/pRp2ppn/2nqp2p/3p4/3P2P1/P1P1PN1P/2P2P2/2BQK2R b Kkq - 0 13");
    assert_eq!(position.get_side(), PieceColor::Black);
  ...
  fn test_zobrist_hash_en_passant_move_by_black() {
    let mut position = Position::from_fen("2rq1r1k/1B2b3/p3p1P1/1p6/3P1pP1/PP1Q4/4n2P/R4KR1 b - g3 0 24");
    assert_eq!(position.get_side(), PieceColor::Black);
  ...
  fn test_zobrist_hash_promotion_move_by_black() {
    let mut position_for_knight_promotion = Position::from_fen("2rq3k/8/p3p1P1/1p6/3PB2b/PP5Q/5r1p/R2K2R1 b - - 3 28");
    assert_eq!(position_for_knight_promotion.get_side(), PieceColor::Black);

    let mov = Move::from_uci_notation("h2h1n", &position_for_knight_promotion).unwrap();
    position_for_knight_promotion.make_move(mov);

    let mut position_for_bishop_promotion = Position::from_fen("2rq4/1B5R/p3pkPQ/8/3P4/1P6/p4r1p/1R1K4 b - - 4 33");
    assert_eq!(position_for_bishop_promotion.get_side(), PieceColor::Black);

    let mov = Move::from_uci_notation("a2b1b", &position_for_bishop_promotion).unwrap();
    position_for_bishop_promotion.make_move(mov);

    let mut position_for_rook_promotion = Position::from_fen("2rq4/1B5R/p3pkPQ/8/3P4/1P6/p4r1p/1R1K4 b - - 4 33");
    assert_eq!(position_for_rook_promotion.get_side(), PieceColor::Black);

    let mov = Move::from_uci_notation("a2a1r", &position_for_rook_promotion).unwrap();
    position_for_rook_promotion.make_move(mov);

    let mut position_for_queen_promotion = Position::from_fen("2rq4/1B5R/p3pkPQ/8/3P4/1P6/p4r1p/1R1K4 b - - 4 33");
    assert_eq!(position_for_queen_promotion.get_side(), PieceColor::Black);

    let mov = Move::from_uci_notation("h2h1q", &position_for_queen_promotion).unwrap();
    position_for_queen_promotion.make_move(mov);

    let expected_position_for_knight_promotion = Position::from_fen("2rq3k/8/p3p1P1/1p6/3PB2b/PP5Q/5r2/R2K2Rn w - - 0 29");
    let expected_position_for_bishop_promotion = Position::from_fen("2rq4/1B5R/p3pkPQ/8/3P4/1P6/5r1p/1b1K4 w - - 0 34");
    let expected_position_for_rook_promotion = Position::from_fen("2rq4/1B5R/p3pkPQ/8/3P4/1P6/5r1p/rR1K4 w - - 0 34");
