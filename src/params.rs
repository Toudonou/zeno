...
// Number of samples: 7,153,653
// Number of iterations: 3,000

use crate::containers::ByPieceType;

pub static MG_PAWN_VALUE: i32 = 198;
pub static EG_PAWN_VALUE: i32 = 258;

pub static MG_KNIGHT_VALUE: i32 = 817;
pub static EG_KNIGHT_VALUE: i32 = 846;

pub static MG_BISHOP_VALUE: i32 = 836;
pub static EG_BISHOP_VALUE: i32 = 857;

pub static MG_ROOK_VALUE: i32 = 1270;
pub static EG_ROOK_VALUE: i32 = 1278;

pub static MG_QUEEN_VALUE: i32 = 2521;
pub static EG_QUEEN_VALUE: i32 = 2558;

pub static MG_KING_VALUE: i32 = 10000;
pub static EG_KING_VALUE: i32 = 10000;

pub static MG_BISHOP_PAIR: i32 = 60;
pub static EG_BISHOP_PAIR: i32 = 120;

#[rustfmt::skip]
static MG_PAWN_TABLE: [i32; 64] = [
   0,    0,    0,    0,    0,    0,    0,    0, 
  86,   63,   69,   78,   78,   69,   63,   86, 
 -18,   11,   63,   41,   41,   63,   11,  -18, 
 -18,   24,   22,   49,   49,   22,   24,  -18, 
 -25,    6,   14,   42,   42,    6,    0,  -26, 
 -17,   11,   15,   12,   20,    7,   19,  -17, 
 -27,   13,    5,    0,    3,   13,   13,  -27, 
   0,    0,    0,    0,    0,    0,    0,    0, 
];
#[rustfmt::skip]
...
static MG_BISHOP_TABLE: [i32; 64] = [
 ...
 -30,   26,   46,   21,   21,   46,   26,  -27, 
 -12,  -17,   13,   35,   35,   13,  -15,  -12, 
  -9,    1,    6,   25,   25,    6,    1,   -9, 
...
static MG_ROOK_TABLE: [i32; 64] = [
   1,   26,    0,   54,   54,   -1,   26,    1, 
   6,    3,   70,   56,   56,   70,    3,    6, 
  -4,   52,   33,   47,   47,   33,   52,   -4, 
 -17,    0,   27,   51,   51,   27,    0,  -18, 
 -35,    1,    0,   25,   25,   -2,    1,  -35, 
 -46,   -8,    0,   11,   11,   -1,   -8,  -46, 
 -68,   -5,   -7,    8,    7,   -7,   -5,  -68, 
  -4,  -15,    6,   40,   40,    6,  -16,  -12, 
];
#[rustfmt::skip]
...
static MG_QUEEN_TABLE: [i32; 64] = [
   1,   23,   36,   52,   52,   36,   23,    3, 
 -14,  -50,   24,    8,    8,   24,  -50,  -13, 
  19,   20,   25,   34,   34,   25,   20,   19, 
  -9,  -27,  -10,   -7,   -7,   -7,  -27,   -6, 
 -13,  -13,  -14,   -8,   -3,  -11,   -6,  -13, 
 -20,    4,  -10,  -11,  -11,   -7,    7,  -20, 
 -52,  -25,   13,    0,    0,   13,  -25,  -52, 
 -36,  -34,  -26,    0,    0,  -26,  -34,  -36, 
];
#[rustfmt::skip]
...
static MG_KING_TABLE: [i32; 64] = [
 ...
 -12,   34,   29,   -2,   -2,   29,   34,  -12, 
-102,    3,  -47,  -65,  -65,  -47,    3, -102, 
 -51,   14,  -31,  -50,  -50,  -31,   12,  -51, 
  36,   38,  -40,  -78,  -78,  -40,   38,   35, 
  28,   68,   34,  -41,   23,  -41,   68,   25, 
];
#[rustfmt::skip]
